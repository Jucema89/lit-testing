...
import '../../src/components/input-component/input-app-component.js';

describe('input-app Incializa comportamientos básicos', () => {
  let component;
  let inputHtml;
  ...
  it('Validación de campo requerido', async () => {
    ...
    expect(component.errorMessage).to.equal('El campo es requerido');
  });
})

describe('input-app Sistema de Validaciones Exitosas', () => {
  let component;
  let inputHtml;
...
describe('input-app Sistema de Validaciones con Error', () => {
  let component;
  let inputHtml;
  ...
  it('Error en Validación  de campo con longitud mínima', async () => {
    ...
    inputHtml.dispatchEvent(new Event('input'));
    await component.updateComplete;
    expect(component.errorMessage).to.equal('El campo debe tener al menos 3 caracteres');
  });
  ...
  it('Validación exitosa de campo con longitud máxima', async () => {
    ...
    expect(component.errorMessage).to.equal('El campo debe tener menos de 10 caracteres');
  });
});

describe('input-app Sistema de Validaciones con Expresiones Regulares', () => {
  let component;
  let inputHtml;
  ...
  it('Error en Password mediante expresion regular', async () => {
    ...
    expect(component.errorMessage).to.equal('El campo no cumple con el formato requerido');
  });
...
describe('input-app Envia los Eventos al Componente Padre', () => {
  let component;
  let inputHtml;
...
describe('Renderizados correctos de Elementos', () => {
  ...
  it('En caso de Error el borde del input es de Color Rojo', async () => {
    ...
    console.log('inputWithError ', inputWithError.classList['0']);
